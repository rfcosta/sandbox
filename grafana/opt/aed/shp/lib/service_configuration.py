...
class ServiceConfiguration():
  ...
  def __init__(self):
    ...
    self.load_topLevelServices(self.results['result']['topLevelServices'])

  def load_topLevelServices(self, topLevelServices):
    for topLevelServiceObj in topLevelServices:
      topLevelService = TopLevelService(topLevelServiceObj)
      self.topLevelServices[topLevelService] = topLevelService

  def get_topLevelServices(self):
